...
def demonstrate_gap_filling():
    ...
    fixed_words = [(0, "BED"), (2, "RAP")]
    target_row = 1
    down_lengths = [3, 4, 6]  # All down words are 3 letters
    ...
    gap_candidates = optimizer.find_words_for_gap(fixed_words, target_row, down_lengths, top_k=10)
